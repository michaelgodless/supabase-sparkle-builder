      ...
      scale: heroScale
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
          ...
          ease: "easeOut"
            ...
            duration: 0.6,
            delay: 0.2
          }} src={navigatorLogo} alt="Navigator House" className="h-20 md:h-24 w-auto mb-2 md:mb-4 drop-shadow-2xl" />
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            duration: 0.6
              ...
              once: true
                ...
                {["Продажа и покупка квартир, домов, коммерческой недвижимости", "Аренда жилой и коммерческой недвижимости", "Юридическое сопровождение сделок", "Помощь в оформлении ипотеки", "Консультации по инвестициям в недвижимость", "Оценка рыночной стоимости объектов"].map((benefit, index) => <motion.div key={index} initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
