        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
          ...
          >
            <motion.img 
              ...
              src={navigatorLogo} 
              alt="Navigator House" 
              className="h-20 md:h-24 w-auto mb-2 md:mb-4 drop-shadow-2xl"
            />
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  ...
                  className="bg-secondary hover:bg-secondary-hover text-white px-6 md:px-8 py-5 md:py-6 text-base md:text-lg shadow-lg hover:shadow-xl transition-all w-full sm:w-auto"
                >
                  Смотреть объекты
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  size="lg" 
                  onClick={() => navigate('/properties')}
                  className="bg-secondary hover:bg-secondary-hover text-white px-8 md:px-10 py-6 md:py-7 text-lg md:text-xl shadow-2xl hover:shadow-secondary/50 transition-all w-full sm:w-auto"
                >
                  Смотреть объекты
